...
public class FileCipherUtil {
    ...
    public static void encrypt(String srcFile, String destFile, String privateKey) throws GeneralSecurityException, IOException {
        ...
        Cipher cipher = Cipher.getInstance(KEY_ALGORITHM + "/ECB/PKCS5Padding");
        cipher.init(Cipher.ENCRYPT_MODE, key);

        fileOpeation(srcFile, destFile, cipher);
    }
    ...
    private static void fileOpeation(String srcFile, String destFile, Cipher cipher) throws GeneralSecurityException, IOException {
    ...
    public static void main(String[] args) throws GeneralSecurityException, IOException {
        //encrypt("/home/luo3300612/Desktop/test/file/12/log.png", "/home/luo3300612/Desktop/test/file/12/log.se", "11111100100110010110");
        decrypt("/home/luo3300612/Desktop/test/file/13/13.se", "/home/luo3300612/Desktop/test/file/12/log.png","10001111101001010110" );
    }
}